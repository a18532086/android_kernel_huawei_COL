...
export TOOL_CHAIN_PATH="/home/a18532086/aarch64-linux-android-4.9-oreo/bin/aarch64-linux-android-"
export objdir="../out"
compile() {
  mkdir $objdir
  make O=$objdir ARCH=arm64 CROSS_COMPILE=$TOOL_CHAIN_PATH $CONFIG_FILE -j8
